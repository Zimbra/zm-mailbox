...
public class BUG_72007 extends UpgradeOp {
    ...
    void doUpgrade() throws ServiceException {
        ...
        upgradeAccount(config.getAttr(Provisioning.A_zimbraSpamIsNotSpamAccount));
        upgradeAccount(config.getAttr(Provisioning.A_zimbraSpamIsSpamAccount));
    }
    ...
    private void upgradeAccount(String name) throws ServiceException {
        if (name != null) {
