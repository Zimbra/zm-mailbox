...
public class WebDavClient {
    ...
    private void logRequestInfo(HttpRequestBase method, String body) throws IOException {
        if (!mDebugEnabled) {
            return;
        }
    ...
    private void logResponseInfo(HttpResponse response) throws IOException {
        if (!mDebugEnabled) {
            return;
        }
    ...
    private final HttpClientBuilder mClient;
