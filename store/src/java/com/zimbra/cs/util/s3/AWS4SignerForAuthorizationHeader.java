...
public class AWS4SignerForAuthorizationHeader extends AWS4SignerBase {
     ...
     * 
     * @param headers
     *            The request headers; 'Host' and 'X-Amz-Date' will be added to this
     *            set.
     * @param queryParameters
     *            Any query parameters that will be added to the endpoint. The
     *            parameters should be specified in canonical format.
     * @param bodyHash
     *            Precomputed SHA256 hash of the request body content; this value
     *            should also be set as the header 'X-Amz-Content-SHA256' for
