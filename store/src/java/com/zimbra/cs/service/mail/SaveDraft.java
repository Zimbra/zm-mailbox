...
public class SaveDraft extends MailDocumentHandler {
    ...
    public Element handle(Element request, Map<String, Object> context) throws ServiceException {
        ...
        boolean isDelegatedReq = request.getAttributeBool("isDelegatedReq", false);
        String delegateeAccountId = request.getAttribute("delegateeAccountId", null);
        ...
        try {
            ...
            if (mailAddress != null) {
                ...
                if (Provisioning.onLocalServer(delegatorAccount)) {
                    ...
                    // Setting the delegator server as the target server in yhe request
