...
public class AutoSendDraftTask extends ScheduledTask<Object> {
    ...
    @Override public Void call() throws Exception {
        ...
        if(delegatorAccount != null && Provisioning.onLocalServer(delegatorAccount)) {
            ...
            Element rqstforDelegatorAcnt = getRequest();
            ...
            if(getServerName() != null && rqstforDelegatorAcnt != null) {
                ...
                rqstforDelegatorAcnt.addAttribute("isDelegatedReq", true);
                rqstforDelegatorAcnt.addAttribute("delegateeAccountId", mbox.getAccountId());
                //Invoking the Soap call for SaveDraftRequest on a delegator's server.
                transport.invoke(rqstforDelegatorAcnt.clone());
            }
        }
