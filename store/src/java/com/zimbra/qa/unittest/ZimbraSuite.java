...
public class ZimbraSuite  {
    ...
    static {
        ...
        sClasses.add(TestImapNotificationsViaEmbeddedLocal.class);
        sClasses.add(TestImapNotificationsViaEmbeddedRemote.class);
        sClasses.add(TestImapNotificationsViaImapDaemon.class);
