...
public final class GlobalExternalStoreConfigConstants {
    ...
    public static final String E_GLOBAL_EXTERNAL_STORE_CONFIG = "global_external_store_config";
    ...
    public static final String A_S3_STORE_TYPE = "storeType";
    ...
    public static final String A_S3_NAMESPACE = "namespace";
    public static final String A_S3_PROXY_PORT = "proxyPort";
    public static final String A_S3_ACCOUNT = "account";
    public static final String A_S3_ACCOUNT_PORT = "accountPort";
