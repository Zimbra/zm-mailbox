...
public class GqlConstants {
    ...
    public static final String CLASS_FILTER_ACTION = "FilterAction";
    public static final String CLASS_DISCARD_ACTION = "DiscardAction";
    public static final String CLASS_KEEP_ACTION = "KeepAction";
    public static final String CLASS_STOP_ACTION = "StopAction";
    public static final String CLASS_FILE_INTO_ACTION = "FileIntoAction";
    public static final String CLASS_FLAG_ACTION = "FlagAction";
    public static final String CLASS_REDIRECT_ACTION = "RedirectAction";
    public static final String CLASS_NOTIFY_ACTION = "NotifyAction";
    public static final String CLASS_RFC_COMPLIANT_NOTIFY_ACTION = "RFCCompliantNotifyAction";
    public static final String CLASS_TAG_ACTION = "TagAction";
    public static final String CLASS_REPLY_ACTION = "ReplyAction";
    public static final String CLASS_REJECT_ACTION = "RejectAction";
    public static final String CLASS_EREJECT_ACTION = "ErejectAction";
    public static final String CLASS_LOG_ACTION = "LogAction";
    public static final String CLASS_ADD_HEADER_ACTION = "AddheaderAction";
    public static final String CLASS_DELETE_HEADER_ACTION = "DeleteheaderAction";
    public static final String CLASS_REPLACE_HEADER_ACTION = "ReplaceheaderAction";
    public static final String FLAG = "flag";
    public static final String MAX_BODY_SIZE = "maxBodySize";
    public static final String ORIGINAL_HEADERS = "origHeaders";
    ...
    public static final String CLASS_ENVELOPE_TEST = "EnvelopeTest";
    public static final String CLASS_ADDRESS_BOOK_TEST = "AddressBookTest";
    public static final String CLASS_ATTACHMENT_TEST = "AttachmentTest";
    public static final String CLASS_BODY_TEST = "BodyTest";
    public static final String CLASS_BULK_TEST = "BulkTest";
    public static final String CLASS_CONTACT_RANKING_TEST = "ContactRankingTest";
    public static final String CLASS_CONVERSATION_TEST = "ConversationTest";
    public static final String WHERE = "where";
    public static final String CLASS_CURRENT_DAY_OF_WEEK_TEST = "CurrentDayOfWeekTest";
    public static final String VALUES = "values";
    public static final String CLASS_CURRENT_TIME_TEST = "CurrentTimeTest";
    public static final String DATE_COMPARISON = "dateComparison";
    public static final String TIME = "time";
    public static final String CLASS_DATE_TEST = "DateTest";
    public static final String CLASS_FACEBOOK_TEST = "FacebookTest";
    public static final String CLASS_FLAGGED_TEST = "FlaggedTest";
    public static final String CLASS_HEADER_EXISTS_TEST = "HeaderExistsTest";
    public static final String CLASS_HEADER_TEST = "HeaderTest";
    public static final String STRING_COMPARISON = "stringComparison";
    public static final String CLASS_IMPORTANCE_TEST = "ImportanceTest";
    public static final String CLASS_INVITE_TEST = "InviteTest";
    public static final String METHODS = "methods";
    public static final String CLASS_LIST_TEST = "ListTest";
    public static final String CLASS_LINKDIN_TEST = "LinkedInTest";
    public static final String CLASS_ME_TEST = "MeTest";
    public static final String CLASS_MIME_HEADER_TEST = "MimeHeaderTest";
    public static final String CLASS_SIZE_TEST = "SizeTest";
    public static final String NUMBER_COMPARISON = "numberComparison";
    public static final String CLASS_SOCIALCAST_TEST = "SocialcastTest";
    public static final String CLASS_TRUE_TEST = "TrueTest";
    public static final String CLASS_TWITTER_TEST = "TwitterTest";
    public static final String CLASS_COMMUNITY_REQUESTS_TEST = "CommunityRequestsTest";
    public static final String CLASS_COMMUNITY_CONTENT_TEST = "CommunityContentTest";
    public static final String CLASS_COMMUNITY_CONNECTIONS_TEST = "CommunityConnectionsTest";
    public static final String CLASS_NESTED_RULE = "NestedRule";
