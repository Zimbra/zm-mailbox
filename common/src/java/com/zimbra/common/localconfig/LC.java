...
public final class LC {
    ...
    @Supported
    public static final KnownKey zimbra_index_retry_queue_size = KnownKey.newKey(10000);

    @Supported
    public static final KnownKey zimbra_index_retry_work_queue_size = KnownKey.newKey(5000);
    ...
    */
    ...
    @Supported
    public static final KnownKey redis_streams_redo_log_stream_prefix = KnownKey.newKey("ZIMBRA_REDO_LOG_STREAM");

    @Supported
    public static final KnownKey redis_num_redolog_streams_per_backup_worker = KnownKey.newKey(10);
