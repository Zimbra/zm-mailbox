...
@XmlRootElement(name=SyncAdminConstants.E_ACCOUNT_ONLY_REMOTE_WIPE_RESPONSE)
@XmlType(propOrder = {})
public class AccountOnlyRemoteWipeResponse {
    ...
    public AccountOnlyRemoteWipeResponse() {
    }
