...
@XmlRootElement(name = SyncAdminConstants.E_CANCEL_PENDING_ACCOUNT_ONLY_REMOTE_WIPE_REQUEST)
public class CancelPendingAccountOnlyRemoteWipeRequest {
    ...
    public CancelPendingAccountOnlyRemoteWipeRequest(AccountSelector account) {
