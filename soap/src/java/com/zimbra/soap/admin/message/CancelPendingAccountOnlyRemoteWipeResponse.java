...
@XmlRootElement(name = SyncAdminConstants.E_CANCEL_PENDING_ACCOUNT_ONLY_REMOTE_WIPE_RESPONSE)
@XmlType(propOrder = {})
public class CancelPendingAccountOnlyRemoteWipeResponse {
    ...
    public CancelPendingAccountOnlyRemoteWipeResponse() {
    }
