 ...
 */
@XmlRootElement(name=AdminConstants.E_MODIFY_VOLUME_INPLACE_UPGRADE_REQUEST)
public class ModifyVolumeInplaceUpgradeRequest {
    ...
    private ModifyVolumeInplaceUpgradeRequest() {
        this((short)-1, (VolumeInfo)null);
    }

    public ModifyVolumeInplaceUpgradeRequest(short id, VolumeInfo volumeInfo) {
        this.id = id;
