...
@XmlRootElement(name=AccountConstants.E_GET_VC_MEETING_INFO_REQUEST)
public class GetVCMeetingInfoRequest {
    ...
    private GetVCMeetingInfoRequest() {
        this((AccountSelector) null);
    }

    public GetVCMeetingInfoRequest(AccountSelector account) {
