...
public final class GlobalS3BucketConfiguration {
    ...
    /**
     * @zm-api-field-tag namespace
     * @zm-api-field-description Global Namespace
     */
    @XmlAttribute(name=GlobalExternalStoreConfigConstants.A_S3_NAMESPACE, /* namespace */ required=false)
    private String namespace;
    
    /**
     * @zm-api-field-tag proxyPort
     * @zm-api-field-description Global Proxy Port
     */
    @XmlAttribute(name=GlobalExternalStoreConfigConstants.A_S3_PROXY_PORT, /* proxyPort */ required=false)
    private String proxyPort;
    
    /**
     * @zm-api-field-tag accountPort
     * @zm-api-field-description Global Account
     */
    @XmlAttribute(name=GlobalExternalStoreConfigConstants.A_S3_ACCOUNT, /* account */ required=false)
    private String account;
    
    /**
     * @zm-api-field-tag accountPort
     * @zm-api-field-description Global Account Port
     */
    @XmlAttribute(name=GlobalExternalStoreConfigConstants.A_S3_ACCOUNT_PORT, /* accountPort */ required=false)
