...
@XmlRootElement(name=XMbxSearchConstants.E_GET_XMBX_SEARCH_REQUEST)
public class GetXMbxSearchRequest {
    ...
    private GetXMbxSearchRequest() {
        this((SearchID) null);
    }

    public GetXMbxSearchRequest(SearchID searchTask) {
