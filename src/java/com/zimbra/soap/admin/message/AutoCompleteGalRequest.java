...
public class AutoCompleteGalRequest {
    ...
    @XmlAttribute(name=AccountConstants.A_GAL_ACCOUNT_ID /* galAcctId */,
                    required=false)
    private String galAccountId;

    @XmlAttribute(name=MailConstants.A_INCLUDE_TAG_DELETED
                    /* includeTagDeleted */, required=false)
    private Boolean includeTagDeleted;

    @XmlAttribute(name=MailConstants.A_ALLOWABLE_TASK_STATUS
                    /* allowableTaskStatus */, required=false)
    private String allowableTaskStatus;

    @XmlAttribute(name=MailConstants.A_CAL_EXPAND_INST_START
                    /* calExpandInstStart */, required=false)
    private Long calItemExpandStart;

    @XmlAttribute(name=MailConstants.A_CAL_EXPAND_INST_END
                    /* calExpandInstEnd */, required=false)
    ...
    // Based on ExpandResults but allows "0" and "false" as synonyms
    // for "none" + "1" for "first"
    ...
    @XmlAttribute(name=MailConstants.A_RESULT_MODE /* resultMode */,
                    required=false)
