...
import com.zimbra.soap.admin.type.ShareInfo;

@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name=AdminConstants.E_GET_PUBLISHED_SHARE_INFO_RESPONSE)
@XmlType(propOrder = {})
public class GetPublishedShareInfoResponse {
    ...
    public GetPublishedShareInfoResponse() {
    }

    public GetPublishedShareInfoResponse(List <ShareInfo> shareInfos) {
        setShareInfos(shareInfos);
    }

    public GetPublishedShareInfoResponse setShareInfos(
    ...
    public GetPublishedShareInfoResponse addShareInfo(ShareInfo shareInfo) {
