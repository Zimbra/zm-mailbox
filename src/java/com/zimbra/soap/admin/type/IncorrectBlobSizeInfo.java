...
public class IncorrectBlobSizeInfo {
    ...
    private final BlobSizeInfo blob;
    ...
    private IncorrectBlobSizeInfo() {
        this(-1, -1, -1L, (short)-1, (BlobSizeInfo) null);
    }

    public IncorrectBlobSizeInfo(int id, int revision, long size,
                    short volumeId, BlobSizeInfo blob) {
        this.id = id;
