...
public class EffectiveRightsTarget {
    ...
    @XmlElement(name=AdminConstants.E_ALL, required=false)
    private final EffectiveRightsInfo all;

    @XmlElement(name=AdminConstants.E_IN_DOMAINS, required=false)
    private List <InDomainInfo> inDomainLists = Lists.newArrayList();

    @XmlElement(name=AdminConstants.E_ENTRIES, required=false)
