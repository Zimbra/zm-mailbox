...
public class MailboxBlobConsistency {
    ...
    public void setIncorrectSizes(
                    Iterable <IncorrectBlobSizeInfo> incorrectSizes) {
    ...
    public MailboxBlobConsistency addIncorrectSize(
                    IncorrectBlobSizeInfo incorrectSize) {
        this.incorrectSizes.add(incorrectSize);
        return this;
    }

    public void setUnexpectedBlobs(
                    Iterable <UnexpectedBlobInfo> unexpectedBlobs) {
    ...
    public MailboxBlobConsistency addUnexpectedBlob(
                    UnexpectedBlobInfo unexpectedBlob) {
        this.unexpectedBlobs.add(unexpectedBlob);
        return this;
    }

    public void setIncorrectRevisions(
                    Iterable <IncorrectBlobRevisionInfo> incorrectRevisions) {
    ...
    public MailboxBlobConsistency addIncorrectRevision(
                    IncorrectBlobRevisionInfo incorrectRevision) {
