...
abstract class Accumulator {
    ...
    static {
        if (mLog.isInfoEnabled()) {
            // xxx 11/22/05 bburtin: The current plan is to replace the Accumulator and StopWatch code
            // with fact tables generated by ZimbraPerf.  Commenting out for now, to make
            // sure no one complains.  Will remove these classes once we're convinced that
