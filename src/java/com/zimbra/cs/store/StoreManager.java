...
public abstract class StoreManager {
     ...
     */
    public Blob storeIncoming(InputStream data, int sizeHint, String path, short volumeId)
    throws IOException, ServiceException {
        return storeIncoming(data, sizeHint, path, volumeId, false);
    }
    ...
    throws IOException, ServiceException {
        ...
        return storeIncoming(new ByteArrayInputStream(data), data.length, path, volumeId, storeAsIs);
    }
