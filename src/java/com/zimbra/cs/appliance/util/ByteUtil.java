 ...
 * Jan 2011
 */
package com.zimbra.cs.appliance.util;
...
public class ByteUtil {
    ...
    public static void closeStream(InputStream is) {
        ...
        if (is instanceof PipedInputStream) {
            try {
                ...
                throw new RuntimeException("ignoring exception while draining PipedInputStream", e);
            }
        }
        ...
        try {
            ...
            throw new RuntimeException("ignoring exception while closing input stream", e);
        }
    }
    ...
    public static void closeStream(OutputStream os) {
        ...
        try {
            ...
            throw new RuntimeException("ignoring exception while closing output stream", e);
        }
    }
    ...
    public static void closeReader(Reader r) {
        ...
        try {
            ...
            throw new RuntimeException("ignoring exception while closing reader", e);
        }
    }
    ...
    public static void closeWriter(Writer w) {
        ...
        try {
            ...
            throw new RuntimeException("ignoring exception while closing writer", e);
        }
    }
