...
public class CreateSearchFolderOperation extends Operation {
	...
	public CreateSearchFolderOperation(Session session, OperationContext oc, Mailbox mbox, Requester req,
				ItemId iidParent, String name, String query, String types, String sort) {
	...
	protected void callback() throws ServiceException {
		mSearch = getMailbox().createSearchFolder(this.getOpCtxt(), mIidParent.getId(), mName, mQuery, mTypes, mSort);
	}
