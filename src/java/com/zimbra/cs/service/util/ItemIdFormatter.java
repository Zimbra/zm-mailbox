...
public class ItemIdFormatter {
    ...
    public ItemIdFormatter()                      { this((String) null, (String) null, false); }
    public ItemIdFormatter(String authId)         { this (authId, authId, false); }
    public ItemIdFormatter(boolean noqualify)     { this((String) null, (String) null, noqualify); }
