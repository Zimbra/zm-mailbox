                ...
                for (Iterator<FileItem> it = files.iterator(); it.hasNext(); ) {
                    ...
                    if (fi != null) {
                        if (fi.isFormField()) {
                            ...
                            ZimbraLog.mailbox.info("UserServlet received file %s - %d bytes",
                                fi.getName() == null ? "unknown" : fi.getName(),
                                fi.getSize());
                            is = new UploadInputStream(fi, limit);
                            break;
                        }
                    }
                }
