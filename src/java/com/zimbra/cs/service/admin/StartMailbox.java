...
public class StartMailbox extends AdminDocumentHandler {
	...
	public Element handle(Element request, Map<String, Object> context)
		...
		checkRight(zsc, context, server, Admin.R_startMailbox);
		RemoteManager rmgr = RemoteManager.getRemoteManager(server);
		RemoteResult rr = rmgr.execute(RemoteCommands.START_MAILBOX);
		Element response = zsc.createElement(AdminConstants.START_MAILBOX_RESPONSE);
		return response;
	}
	
    @Override
    public void docRights(List<AdminRight> relatedRights, List<String> notes) {
        relatedRights.add(Admin.R_startMailbox);
