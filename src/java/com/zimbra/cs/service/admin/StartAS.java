...
public class StartAS extends AdminDocumentHandler {
	@Override
	public Element handle(Element request, Map<String, Object> context)
		...
		checkRight(zsc, context, server, Admin.R_startAntiSpam);
		RemoteManager rmgr = RemoteManager.getRemoteManager(server);
		RemoteResult rr = rmgr.execute(RemoteCommands.START_AS);
		Element response = zsc.createElement(AdminConstants.START_AS_RESPONSE);
		return response;
	}
	
    @Override
    public void docRights(List<AdminRight> relatedRights, List<String> notes) {
        relatedRights.add(Admin.R_startAntiSpam);
