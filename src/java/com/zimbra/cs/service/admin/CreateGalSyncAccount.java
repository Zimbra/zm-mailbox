...
public class CreateGalSyncAccount extends AdminDocumentHandler {
    ...
    public Element handle(Element request, Map<String, Object> context) throws ServiceException {
        ...
        if (account == null) {
            ...
            StringUtil.addToMultiMap(accountAttrs, Provisioning.A_zimbraIsSystemResource, LegacyLdapUtil.LDAP_TRUE);
            StringUtil.addToMultiMap(accountAttrs, Provisioning.A_zimbraHideInGal, LegacyLdapUtil.LDAP_TRUE);
