...
public class StartSpell extends AdminDocumentHandler {
	@Override
	public Element handle(Element request, Map<String, Object> context)
		...
		checkRight(zsc, context, server, Admin.R_startSpell);
		RemoteManager rmgr = RemoteManager.getRemoteManager(server);
		RemoteResult rr = rmgr.execute(RemoteCommands.START_SPELL);
		Element response = zsc.createElement(AdminConstants.START_SPELL_RESPONSE);
		return response;
	}
	
    @Override
    public void docRights(List<AdminRight> relatedRights, List<String> notes) {
        relatedRights.add(Admin.R_startSpell);
