...
public class StopAV extends AdminDocumentHandler {
	@Override
	public Element handle(Element request, Map<String, Object> context)
		...
		checkRight(zsc, context, server, Admin.R_stopAntiVirus);
		RemoteManager rmgr = RemoteManager.getRemoteManager(server);
		RemoteResult rr = rmgr.execute(RemoteCommands.STOP_AV);
		Element response = zsc.createElement(AdminConstants.STOP_AV_RESPONSE);
		return response;
	}
	
    @Override
    public void docRights(List<AdminRight> relatedRights, List<String> notes) {
        relatedRights.add(Admin.R_stopAntiVirus);
