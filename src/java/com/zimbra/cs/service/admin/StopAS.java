...
public class StopAS extends AdminDocumentHandler {
	...
	public Element handle(Element request, Map<String, Object> context)
		...
		checkRight(zsc, context, server, Admin.R_stopAntiSpam);
		RemoteManager rmgr = RemoteManager.getRemoteManager(server);
		RemoteResult rr = rmgr.execute(RemoteCommands.STOP_AS);
		Element response = zsc.createElement(AdminConstants.STOP_AS_RESPONSE);
		return response;
	}
	
    @Override
    public void docRights(List<AdminRight> relatedRights, List<String> notes) {
        relatedRights.add(Admin.R_stopAntiSpam);
