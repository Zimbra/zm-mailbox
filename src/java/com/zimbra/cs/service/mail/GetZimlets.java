...
public class GetZimlets extends DocumentHandler  {
	...
	public Element handle(Element request, Map context) throws ServiceException {
        ...
        String type = request.getAttribute(MailService.A_ITEM_TYPE, null);

        Element response = lc.createElement(MailService.GET_ZIMLETS_RESPONSE);
