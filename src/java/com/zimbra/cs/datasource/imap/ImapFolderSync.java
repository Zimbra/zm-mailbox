...
class ImapFolderSync {
    ...
    public static class RemoteFolder {
        private final ImapConnection connection;
    ...
    public static final class LocalFolder {
        private final com.zimbra.cs.mailbox.Mailbox mbox;
        private final String path;
        private Folder folder;
        private static final Log LOG = ZimbraLog.datasource;

        public static LocalFolder fromId(com.zimbra.cs.mailbox.Mailbox mbox, int id) throws ServiceException {
            try {
        ...
        public static LocalFolder fromPath(com.zimbra.cs.mailbox.Mailbox mbox, String path) throws ServiceException {
            try {
        ...
        LocalFolder(com.zimbra.cs.mailbox.Mailbox mbox, String path) throws ServiceException {
            this.mbox = mbox;
            this.path = path;
        }

        LocalFolder(com.zimbra.cs.mailbox.Mailbox mbox, Folder folder) throws ServiceException {
            this.mbox = mbox;
        ...
        public boolean isKnown() {
            switch (folder.getId()) {
            case com.zimbra.cs.mailbox.Mailbox.ID_FOLDER_INBOX:
            case com.zimbra.cs.mailbox.Mailbox.ID_FOLDER_TRASH:
            case com.zimbra.cs.mailbox.Mailbox.ID_FOLDER_SPAM:
            case com.zimbra.cs.mailbox.Mailbox.ID_FOLDER_SENT:
            case com.zimbra.cs.mailbox.Mailbox.ID_FOLDER_DRAFTS:
                return true;
            default:
                return false;
            }
        ...
        public boolean isSystem() {
            return folder.getId() < com.zimbra.cs.mailbox.Mailbox.FIRST_USER_ID;
        }
