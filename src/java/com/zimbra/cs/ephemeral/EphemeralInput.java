 ...
 *    Depending on whether the @EphemeralBackend natively supports key expiration,
 *    this will either be encoded in the value to be used by @EphemeralBackend.purgeExpired(),
 *    or leveraged by the backend's own key expiration mechanism.
 * 2) Whether the key/value pair is dynamic. If the @EphemeralBackend supports
