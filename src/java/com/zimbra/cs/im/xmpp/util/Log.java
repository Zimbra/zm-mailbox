...
// import com.zimbra.cs.im.xmpp.util.log.Logger;
// import com.zimbra.cs.im.xmpp.util.log.Priority;
// import com.zimbra.cs.im.xmpp.util.log.format.ExtendedPatternFormatter;
// import com.zimbra.cs.im.xmpp.util.log.output.io.StreamTarget;
// import com.zimbra.cs.im.xmpp.util.log.output.io.rotate.RevolvingFileStrategy;
// import com.zimbra.cs.im.xmpp.util.log.output.io.rotate.RotateStrategyBySize;
// import com.zimbra.cs.im.xmpp.util.log.output.io.rotate.RotatingFileTarget;
...
//     private static final Logger ZimbraLog.im = Hierarchy.getDefaultHierarchy().getLoggerFor("Jive-DEBUG");
//     private static final Logger ZimbraLog.im = Hierarchy.getDefaultHierarchy().getLoggerFor("Jive-INFO");
//     private static final Logger ZimbraLog.im. = Hierarchy.getDefaultHierarchy().getLoggerFor("Jive-WARN");
...
//         createLogger(debugPattern, logNameDebug, maxDebugSize, ZimbraLog.im, Priority.DEBUG);
//         createLogger(infoPattern, logNameInfo, maxInfoSize, ZimbraLog.im, Priority.INFO);
//         createLogger(warnPattern, logNameWarn, maxWarnSize, ZimbraLog.im., Priority.WARN);
...
//         RotatingFileTarget target = (RotatingFileTarget) ZimbraLog.im.getLogTargets()[0];
