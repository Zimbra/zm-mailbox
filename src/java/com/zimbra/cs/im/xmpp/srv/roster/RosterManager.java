...
import com.zimbra.cs.im.xmpp.srv.RoutingTable;
...
import com.zimbra.cs.im.xmpp.srv.event.GroupEventDispatcher;
import com.zimbra.cs.im.xmpp.srv.event.GroupEventListener;
...
public class RosterManager extends BasicModule implements GroupEventListener {
     ...
     * @throws com.zimbra.cs.im.xmpp.srv.user.UserNotFoundException if the ID does not correspond
