 ...
 */
public class OldOfflineMessageStore extends BasicModule implements UserEventListener {
     ...
     */
    public static OldOfflineMessageStore getInstance() {
