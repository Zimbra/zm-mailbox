...
import com.zimbra.cs.im.xmpp.srv.audit.spi.AuditManagerImpl;
import com.zimbra.cs.im.xmpp.srv.commands.AdHocCommandHandler;
import com.zimbra.cs.im.xmpp.srv.component.InternalComponentManager;
//import com.zimbra.cs.im.xmpp.srv.container.AdminConsolePlugin;
import com.zimbra.cs.im.xmpp.srv.container.Module;
//import com.zimbra.cs.im.xmpp.srv.container.PluginManager;
import com.zimbra.cs.im.xmpp.srv.disco.IQDiscoInfoHandler;
import com.zimbra.cs.im.xmpp.srv.disco.IQDiscoItemsHandler;
import com.zimbra.cs.im.xmpp.srv.disco.ServerFeaturesProvider;
import com.zimbra.cs.im.xmpp.srv.disco.ServerItemsProvider;
import com.zimbra.cs.im.xmpp.srv.filetransfer.FileTransferProxy;
import com.zimbra.cs.im.xmpp.srv.handler.*;
import com.zimbra.cs.im.xmpp.srv.muc.MultiUserChatServer;
import com.zimbra.cs.im.xmpp.srv.muc.spi.MultiUserChatServerImpl;
//import com.zimbra.cs.im.xmpp.srv.net.MulticastDNSService;
 ...
 * For more information see: {@link com.zimbra.cs.im.xmpp.srv.container.PluginManager}.<p>
 * <p/>
...
//    private PluginManager pluginManager;
    ...
    private static final String STARTER_CLASSNAME =
            "com.zimbra.cs.im.xmpp.srv.starter.ServerStarter";
     ...
     */
    public XMPPServer() throws Exception {
...
//        start();
    ...
    private void initialize() throws FileNotFoundException, IOException {
        ...
        if (JiveGlobals.failedLoading) {
        	throw new FileNotFoundException("Error loading IM server properties");
        }

        version = new Version(2, 6, 0, Version.ReleaseStatus.Release, -1);
...
//        loadModule(MulticastDNSService.class.getName());
     ...
     * standalone if the "com.zimbra.cs.im.xmpp.srv.starter.ServerStarter" class is present in the
     * system.
     *
...
//    }
    ...
    private void locateWildfire() throws FileNotFoundException, IOException {
    	...
    	JiveGlobals.loadSetupProperties();
