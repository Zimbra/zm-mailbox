 ...
 */
public class OldRosterItemProvider {
    ...
    private static OldRosterItemProvider instance = new OldRosterItemProvider();

    public static OldRosterItemProvider getInstance() {
        return instance;
    }
