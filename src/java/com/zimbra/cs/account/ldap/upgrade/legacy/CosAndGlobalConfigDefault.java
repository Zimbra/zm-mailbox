...
public class CosAndGlobalConfigDefault extends LegacyLdapUpgrade {
    ...
    boolean parseCommandLine(CommandLine cl) {
        ...
        if (args == null || args.length != 1) {
            LegacyLdapUpgrade.usage(null, this, "missing required argument: since");
            return false;
        }
        ...
        try {
            ...
            LegacyLdapUpgrade.usage(null, this, "invalid version: " + args[0]);
            return false;
        }
        return true;
    }
