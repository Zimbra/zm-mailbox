...
public abstract class LegacyLdapUpgrade {
    
    protected String mBug;
    protected boolean mVerbose;
    protected LdapProv mProv;
    
    LegacyLdapUpgrade() throws ServiceException {
    ...
    static void usage(ParseException e, LegacyLdapUpgrade ldapUpgrade, String errMsg) {
        if (e != null)
    ...
    * @param args
     */
    public static void legacyMain(String[] args) throws ServiceException {
        
        System.out.print(LegacyLdapUpgrade.class.getCanonicalName() + " ");
        for (String arg : args)
        ...
        try {
            ...
            LegacyLdapUpgrade.usage(e, null, null);
            System.exit(1);
        }
        
        if (cl.hasOption(O_HELP)) {
            LegacyLdapUpgrade.usage();
            System.exit(0);
        }
