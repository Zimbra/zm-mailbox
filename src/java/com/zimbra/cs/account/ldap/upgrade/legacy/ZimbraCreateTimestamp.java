...
public class ZimbraCreateTimestamp extends LegacyLdapUpgrade {
    ...
    boolean parseCommandLine(CommandLine cl) {
        ...
        if (args.length == 1) {
            try {
                ...
                LegacyLdapUpgrade.usage(null, this, "invalid type: " + args[0]);
                return false;
            }
        } else if (args.length != 0) {
            LegacyLdapUpgrade.usage(null, this, "invalid arg");
            return false;
        }
        return true;
    }
