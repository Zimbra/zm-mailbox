...
public class LdapGalMapRules {
    ...
    private static final String CURRENT_DEFAULT_GROUPHANDLER = "com.zimbra.cs.gal.ADGalGroupHandler";
    private static final String FUTURE_DEFAULT_GROUPHANDLER = "com.zimbra.cs.account.grouphandler.ADGroupHandler";
    ...
    private void init(String[] rules, String[] valueMaps, String groupHandlerClass) {
        ...
        if (StringUtil.equal(groupHandlerClass, FUTURE_DEFAULT_GROUPHANDLER)) {
