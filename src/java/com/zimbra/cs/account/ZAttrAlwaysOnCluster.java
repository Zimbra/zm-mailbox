...
public abstract class ZAttrAlwaysOnCluster extends NamedEntry {
     ...
     *
     * @return zimbraMtaSmtpDnsSupportLevel, or null if unset and/or has invalid value
     *
     * @since ZCS 8.7.0,9.0.0
     */
    @ZAttr(id=2075)
    public ZAttrProvisioning.MtaSmtpDnsSupportLevel getMtaSmtpDnsSupportLevel() {
        try { String v = getAttr(Provisioning.A_zimbraMtaSmtpDnsSupportLevel); return v == null ? null : ZAttrProvisioning.MtaSmtpDnsSupportLevel.fromString(v); } catch(com.zimbra.common.service.ServiceException e) { return null; }
    }
     ...
     * <p>Valid values: [enabled, disabled, dnssec]
     *
     * @return zimbraMtaSmtpDnsSupportLevel, or null if unset
     *
     * @since ZCS 8.7.0,9.0.0
     */
    @ZAttr(id=2075)
    public String getMtaSmtpDnsSupportLevelAsString() {
        return getAttr(Provisioning.A_zimbraMtaSmtpDnsSupportLevel, null);
    }
     ...
     * <p>Valid values: [yes, no]
     *
     * @return zimbraMtaSmtpdTlsReceivedHeader, or null if unset and/or has invalid value
     *
     * @since ZCS 8.7.0,9.0.0
     */
    @ZAttr(id=2076)
    public ZAttrProvisioning.MtaSmtpdTlsReceivedHeader getMtaSmtpdTlsReceivedHeader() {
        try { String v = getAttr(Provisioning.A_zimbraMtaSmtpdTlsReceivedHeader); return v == null ? null : ZAttrProvisioning.MtaSmtpdTlsReceivedHeader.fromString(v); } catch(com.zimbra.common.service.ServiceException e) { return null; }
    }
     ...
     * <p>Valid values: [yes, no]
     *
     * @return zimbraMtaSmtpdTlsReceivedHeader, or null if unset
     *
     * @since ZCS 8.7.0,9.0.0
     */
    @ZAttr(id=2076)
    public String getMtaSmtpdTlsReceivedHeaderAsString() {
        return getAttr(Provisioning.A_zimbraMtaSmtpdTlsReceivedHeader, null);
    }
