...
public class ProvUtil implements HttpDebugListener {
    ...
    public enum Command {
        ...
        FLUSH_CACHE("flushCache", "fc", "{skin|locale|account|config|cos|domain|group|server|zimlet|<extension-cache-type>} [name1|id1 [name2|id2...]]", Category.MISC, 1, Integer.MAX_VALUE),
...
//        int iPerPage = 0;        
    ...
    private void doGetRightsDoc(String[] args) throws ServiceException {
        ...
        System.out.println("#");
        System.out.println("#  Generated by: zmprov grd");
        System.out.println("#");
