...
public class ProvUtil implements HttpDebugListener {
    ...
    public enum Command {
        ...
        ADD_ACCOUNT_LOGGER("addAccountLogger", "aal",
        ...
        CHECK_RIGHT(
                ...
                "{src-cos-name|id} {dest-cos-name}", Category.COS, 2, 2),
        COUNT_ACCOUNT("countAccount", "cta",
                "{domain|id}", Category.DOMAIN, 1, 1),
        ...
        CREATE_UC_SERVICE(
                "createUCService", "cucs", "{name} [attr1 value1 [attr2 value2...]]", Category.UCSERVICE, 1, Integer.MAX_VALUE),
        CREATE_IDENTITY("createIdentity", "cid",
                "{name@domain} {identity-name} [attr1 value1 [attr2 value2...]]", Category.ACCOUNT, 2, Integer.MAX_VALUE),
        CREATE_SIGNATURE("createSignature", "csig",
                "{name@domain} {signature-name} [attr1 value1 [attr2 value2...]]", Category.ACCOUNT, 2, Integer.MAX_VALUE),
        ...
        DESCRIBE("describe", "desc",
                ...
                true), EXIT("exit", "quit", "", Category.MISC, 0, 0),
        ...
        GET_ALWAYSONCLUSTER(
                "getAlwaysOnCluster", "gaoc", "{name|id} [attr1 [attr2...]]", Category.ALWAYSONCLUSTER, 1, Integer.MAX_VALUE),
        ...
        GET_ALL_EFFECTIVE_RIGHTS("getAllEffectiveRights", "gaer",
        ...
        GET_DISTRIBUTION_LIST("getDistributionList", "gdl", "{list@domain|id} [attr1 [attr2...]]", Category.LIST, 1,
                Integer.MAX_VALUE),
        ...
        REMOVE_DISTRIBUTION_LIST_MEMBER(
                "removeDistributionListMember", "rdlm", "{list@domain|id} {member@domain}", Category.LIST, 2, Integer.MAX_VALUE),
        ...
        RELOAD_MEMCACHED_CLIENT_CONFIG(
                ...
                Integer.MAX_VALUE, Via.soap), 
        GET_MEMCACHED_CLIENT_CONFIG("getMemcachedClientConfig", "gmcc",
                "all | mailbox-server [...]", Category.MISC, 1, Integer.MAX_VALUE, Via.soap), SOAP(".soap", ".s"), 
