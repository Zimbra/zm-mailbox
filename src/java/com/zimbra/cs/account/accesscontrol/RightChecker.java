...
public class RightChecker {
    ...
    private static void getEffectiveRights(
        ...
        if (rightBearer instanceof GlobalAdmin) {
            ...
            allowSetAttrs = CheckAttrRight.accessibleAttrs(grantee, target, AdminRight.PR_SET_ATTRS, false);
            
            // get effective getAttrs rights
            allowGetAttrs = CheckAttrRight.accessibleAttrs(grantee, target, AdminRight.PR_GET_ATTRS, false);
        }
