		...
		try {
			...
			if(acct != null) {
    	    	if(isRegisteredInternal(acct)) {
        	    	...
        	    	/*
        	    	 * If we are here, we did not find the token in the cached account object.
        	    	 * Either token has been invalidated or it was generated by another server, therefore reload the object and check one more time.
        	    	 */
    	    	    prov.reload(acct);
