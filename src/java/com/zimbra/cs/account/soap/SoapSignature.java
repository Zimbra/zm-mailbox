...
class SoapSignature extends Signature implements SoapEntry {
    ...
    public void modifyAttrs(SoapProvisioning prov, Map<String, ? extends Object> attrs, boolean checkImmutable) throws ServiceException {
        /*
        XMLElement req = new XMLElement(AccountService.MODIFY_SIGNATURE_REQUEST);
        Element signature = req.addElement(AccountService.E_SIGNATURE);
        signature.addAttribute(AccountService.A_NAME, getName());
        SoapProvisioning.addAttrElements(signature, attrs);
