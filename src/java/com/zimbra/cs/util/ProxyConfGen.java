...
public class ProxyConfGen
{
    ...
    public static void buildDefaultVars ()
    {
        ...
        mConfVars.put("mail.whitelist.ttl", new ProxyConfVar("mail.whitelist.ttl", "zimbraReverseProxyIPThrottleWhitelistTime", 300, ProxyConfValueType.INTEGER, ProxyConfOverride.CONFIG,"Time-to-live, in seconds, of the list of servers for which IP throttling is disabled"));
