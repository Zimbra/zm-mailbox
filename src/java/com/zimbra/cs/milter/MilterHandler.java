...
public abstract class MilterHandler extends ProtocolHandler {
    ...
    private void getAddrFromMacro(IoBuffer macroData, String macro, String attr) {
    ...
    private String getNullTermStr(IoBuffer buf) {
        IoBuffer strbuf = IoBuffer.allocate(128);
    ...
    private Map<String, String> parseMacros(IoBuffer buf) {
