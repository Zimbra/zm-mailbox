...
/**
 * A distributed ZooKeeper-based {@link MailboxLock} adapter.
 *
 */
public class ZooKeeperMailboxLock implements MailboxLock {
    ...
    public ZooKeeperMailboxLock(String id, Mailbox mbox) {
