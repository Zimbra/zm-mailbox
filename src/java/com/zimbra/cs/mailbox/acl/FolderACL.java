...
public class FolderACL {
    ...
    private ACL getEffectiveACLFromCache() throws ServiceException {
        ...
        return effectiveACLCache.get(new EffectiveACLCache.Key(mShareTarget.getAccountId(), mShareTarget.getFolderId()));
    }
    ...
    public static Short getEffectivePermissionsLocal(OperationContext octxt, Mailbox ownerMbx, Folder folder) throws ServiceException {
        ...
        EffectiveACLCache effectiveACLCache = Zimbra.getAppContext().getBean(EffectiveACLCache.class);
        effectiveACLCache.put(new EffectiveACLCache.Key(folder.getAccount().getId(), folder.getId()), acl);
