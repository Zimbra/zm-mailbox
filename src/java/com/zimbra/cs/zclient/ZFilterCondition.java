    ...
    public static ZFilterCondition getCondition(Element condEl) throws ServiceException {
        ...
        if (n.equals(C_HEADER)) {
            return new ZHeaderCondition(
                    getK0(condEl),
                    HeaderOp.fromString(condEl.getAttribute(MailService.A_OPERATION)),
                    getK1(condEl));
            ...
            try {
                return new ZDateCondition(
                        ...
                        DateOp.fromString(condEl.getAttribute(MailService.A_OPERATION)));
            ...
            return new ZSizeCondition(
                    ...
                    SizeOp.fromString(condEl.getAttribute(MailService.A_OPERATION)));
        } else if (n.equals(C_BODY)) {
            return new ZBodyCondition(BodyOp.fromString(condEl.getAttribute(MailService.A_OPERATION)),getK1(condEl));
            ...
            return new ZAddressBookCondition(
                    AddressBookOp.fromString(condEl.getAttribute(MailService.A_OPERATION)),
                    getK0(condEl));
        } else {
