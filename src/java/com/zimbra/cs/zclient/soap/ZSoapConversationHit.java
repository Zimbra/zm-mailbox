...
class ZSoapConversationHit implements ZConversationHit {
    ...
    ZSoapConversationHit(Element e, Map<String,ZSoapEmailAddress> cache) throws ServiceException {
        ...
        mMbx = e.getAttribute(MailService.E_MAILBOX, null);
    ...
    public String toString() {
        ...
        return String.format("convhit: { id: %s, flags: %s, fragment: %s, subject: %s, mbx: %s, sortfield: %s, msgcount: %d, msgIds: %s, recipients: %s }",
                mId, mFlags, mFragment, mSubject, mMbx, mSortField, mMessageCount, mMessageIds, sb.toString()); 
    }
