...
public class UBIDAttributes extends ZAttributes {
    ...
    public static final String[] ALL_ATTRS_PLUS_ENTRY_CSN = {"*", ENTRY_CSN};
    ...
    private void processEntryCSN() {
        entryCSN = entry.getAttributeValue(ENTRY_CSN);
    }
    ...
    public Map<String, Object> getAttrs(Set<String> extraBinaryAttrs)
        ...
        /* We add operational attribute EntryCSN to the filter for some searches to aid detecting modifications
         * but we don't want to expose it as a general attribute.
         */
        map.remove(UBIDAttributes.ENTRY_CSN);
        return map;
    }
