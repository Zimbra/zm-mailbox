...
public abstract class ZAttributes extends ZLdapElement implements IAttributes {
     ...
     * This is a Change Sequence Number (CSN) attribute on an entry which always changes with modifications.
     * The openLDAP attribute is called entryCSN
     * @return the entryCSN (if available) otherwise null
     */
