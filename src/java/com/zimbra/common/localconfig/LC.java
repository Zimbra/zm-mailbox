...
public final class LC {
    ...
    public static final KnownKey soap_fault_include_stack_trace = KnownKey.newKey(true).reloadable();
    ...
    public static final KnownKey soap_response_chunked_transfer_encoding_enabled = KnownKey.newKey(true).reloadable();
