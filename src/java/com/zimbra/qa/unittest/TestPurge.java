...
public class TestPurge extends TestCase {
    ...
    throws Exception {
        ...
        Message purgedUnread = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_INBOX, 1, prefix + "purgedUnread",
            System.currentTimeMillis() - (25 * Constants.MILLIS_PER_HOUR));
        Message keptUnread = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_INBOX, 2, prefix + "keptUnread",
            System.currentTimeMillis() - (18 * Constants.MILLIS_PER_HOUR));
        Message purgedRead = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_INBOX, 3, prefix + "purgedRead",
            System.currentTimeMillis() - (18 * Constants.MILLIS_PER_HOUR));
        Message keptRead = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_INBOX, 4, prefix + "keptRead",
    ...
    throws Exception {
        ...
        Mailbox mbox = TestUtil.getMailbox(USER_NAME);
        Message purged = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_SENT, 1, prefix + "purged",
            System.currentTimeMillis() - (25 * Constants.MILLIS_PER_HOUR));
        Message kept = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_SENT, 2, prefix + "kept",
            System.currentTimeMillis() - (18 * Constants.MILLIS_PER_HOUR));
    ...
    throws Exception {
        ...
        Mailbox mbox = TestUtil.getMailbox(USER_NAME);
        Message purged = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_TRASH, 1, prefix + "purged",
            System.currentTimeMillis() - (36 * Constants.MILLIS_PER_HOUR));
        Message kept = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_TRASH, 2, prefix + "kept",
    ...
    throws Exception {
        ...
        Mailbox mbox = TestUtil.getMailbox(USER_NAME);
        Message purged = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_SPAM, 1, prefix + "purged",
            System.currentTimeMillis() - (36 * Constants.MILLIS_PER_HOUR));
        Message kept = TestUtil.insertMessage(mbox, Mailbox.ID_FOLDER_SPAM, 2, prefix + "kept",
            System.currentTimeMillis() - (16 * Constants.MILLIS_PER_HOUR));
    ...
    throws Exception {
        ...
        Message purged = TestUtil.insertMessage(mbox, folder.getId(), 1, prefix + "purged",
            System.currentTimeMillis() - (41 * Constants.MILLIS_PER_DAY));
        Message kept = TestUtil.insertMessage(mbox, folder.getId(), 2, prefix + "kept",
