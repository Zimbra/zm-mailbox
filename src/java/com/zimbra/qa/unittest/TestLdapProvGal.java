...
public class TestLdapProvGal extends TestLdap {
    ...
    private static String baseDomainName() {
        return TestLdapProvGal.class.getName().toLowerCase();
    }
    ...
    public void checkGalConfig() throws Exception {
        String ACCT_NAME_LOCALPART = TestLdap.makeAccountNameLocalPart("checkGalConfig");
    ...
    public void searchGal() throws Exception {
        ...
        for (int i = 0; i < NUM_ACCTS; i++) {
            String ACCT_NAME_LOCALPART = TestLdap.makeAccountNameLocalPart("searchGal" + i);
            Account acct = createAccount(ACCT_NAME_LOCALPART);
    ...
    public void searchGalADGroupMember() throws Exception {
        ...
        Domain galDomain = TestLdapProvDomain.createDomain(prov, DOMAIN_NAME, domainAttrs);
        
        String ACCT_NAME_LOCALPART = TestLdap.makeAccountNameLocalPart("searchGalADGroupMember");
        Account user = TestLdapProvAccount.createAccount(prov, ACCT_NAME_LOCALPART, galDomain, null);
