...
public class TestLdapProvDistributionList extends TestLdap {
    ...
    throws Exception {
        return createDistributionList(prov, localPart, domain, attrs);
    }
    
    private void deleteDistributionList(DistributionList dl) throws Exception {
        deleteDistributionList(prov, dl);
    }
    ...
    public void createDistributionList() throws Exception {
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("createDistributionList");
    ...
    public void createDistributionListAlreadyExists() throws Exception {
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("createDistributionListAlreadyExists");
        DistributionList dl = createDistributionList(DL_NAME_LOCALPART);
    ...
    public void getDistributionList() throws Exception {
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("getDistributionList");
        DistributionList dl = createDistributionList(DL_NAME_LOCALPART);
    ...
    public void renameDistributionList() throws Exception {
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("renameDistributionList");
        String DL_NEW_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("renameDistributionList-new");
    ...
    public void addMembers() throws Exception {
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("addMembers");
    ...
    public void accountInDistributionList() throws Exception {
        ...
        String ACCT_NAME_IN_DL_LOCALPART = TestLdap.makeAccountNameLocalPart("accountInDistributionList-acct-in");
    ...
    public void dlInDistributionList() throws Exception {
        ...
        String DL_NAME_IN_DL_LOCALPART = TestLdap.makeDLNameLocalPart("dlInDistributionList-dl-in");
        DistributionList dlInDL = createDistributionList(DL_NAME_IN_DL_LOCALPART);
        String DL_NAME_NOT_IN_DL_LOCALPART = TestLdap.makeDLNameLocalPart("dlInDistributionList-dl-not-in");
    ...
    public void getAccountDistributionLists() throws Exception {
        String DL_NAME_1_LOCALPART = TestLdap.makeDLNameLocalPart("getAccountDistributionLists-dl-1");
        String DL_NAME_2_LOCALPART = TestLdap.makeDLNameLocalPart("getAccountDistributionLists-dl-2");
        ...
        String ACCT_NAME_LOCALPART = TestLdap.makeAccountNameLocalPart("getAccountDistributionLists-acct");
    ...
    public void getDlDistributionLists() throws Exception {
        String DL_NAME_1_LOCALPART = TestLdap.makeDLNameLocalPart("getDlDistributionLists-dl-1");
        String DL_NAME_2_LOCALPART = TestLdap.makeDLNameLocalPart("getDlDistributionLists-dl-2");
        DistributionList dl1 = createDistributionList(DL_NAME_1_LOCALPART);
        DistributionList dl2 = createDistributionList(DL_NAME_2_LOCALPART);
        
        String DL_NAME_LOCALPART = TestLdap.makeDLNameLocalPart("getDlDistributionLists-dl");
        DistributionList dl = createDistributionList(DL_NAME_LOCALPART);
