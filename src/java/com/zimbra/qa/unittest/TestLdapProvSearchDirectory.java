...
public class TestLdapProvSearchDirectory extends TestLdap {
    ...
    private static String baseDomainName() {
        return TestLdapProvSearchDirectory.class.getName().toLowerCase();
    }
    ...
    private CalendarResource createCalendarResource(String localPart,
            Domain domain, Map<String, Object> attrs) throws Exception {
        return TestLdapProvAccount.createCalendarResource(
                prov, localPart, domain, attrs);
    }
    ...
    private DistributionList createDistributionList(String localPart, 
            Domain domain, Map<String, Object> attrs) throws Exception {
        return TestLdapProvDistributionList.createDistributionList(
                prov, localPart, domain, attrs);
    }
    ...
    throws Exception {
        return TestLdapProvServer.createServer(prov, serverName, null);
    }
    ...
    public void getAllGroups() throws Exception {
        ...
        Domain subDomain = TestLdapProvDomain.createDomain(prov, SUB_DOMAIN_NAME, null);
