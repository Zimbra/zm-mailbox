...
extends TestCase {
    ...
    throws Exception {
        ...
        TestUtil.setServerAttr(Provisioning.A_zimbraSoapExposeVersion, LdapUtilCommon.LDAP_TRUE);
        Element response = transport.invoke(request);
        validateSoapVersionResponse(response);
        
        // Test with version not exposed
        TestUtil.setServerAttr(Provisioning.A_zimbraSoapExposeVersion, LdapUtilCommon.LDAP_FALSE);
