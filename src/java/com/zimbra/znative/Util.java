...
public class Util {
    ...
    private static boolean loadLibrary() {
        ...
        try {
            ...
            // Catch and proceed. Otherwise this would become an
            // ExceptionInInitializerError and would stall startup on platforms
            // where we do not have the requisite native code.
        }
        return false;
    }
