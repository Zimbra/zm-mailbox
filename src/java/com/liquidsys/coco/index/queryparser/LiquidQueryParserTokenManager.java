/* Generated By:JavaCC: Do not edit this line. LiquidQueryParserTokenManager.java */
package com.liquidsys.coco.index.queryparser;
import com.liquidsys.coco.index.*;
...
public class LiquidQueryParserTokenManager implements LiquidQueryParserConstants
{
...
public LiquidQueryParserTokenManager(JavaCharStream stream)
{
   if (JavaCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public LiquidQueryParserTokenManager(JavaCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
