...
public class PermCacheManagerTest {
    ...
    public void testMaxAge() throws Exception {
        ...
        Provisioning.getInstance().getLocalServer().setAdminAclCacheTargetMaxAge(acl_cache_target_maxage);
    ...
    public void testPermCacheManager() throws Exception {
        ...
        */
        ...
        Provisioning.getInstance().getLocalServer().setAdminAclCacheTargetMaxsize(acl_cache_target_maxsize);
        Provisioning.getInstance().getLocalServer().setAdminAclCacheCredentialMaxsize(acl_cache_credential_maxsize);
        Provisioning.getInstance().getLocalServer().setAdminAclCacheTargetMaxAge(acl_cache_target_maxage);
