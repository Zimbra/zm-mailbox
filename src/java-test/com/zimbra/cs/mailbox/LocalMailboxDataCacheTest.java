...
/**
 * Unit test for {@link LocalMailboxDataCache}.
 */
public final class LocalMailboxDataCacheTest extends AbstractMailboxDataCacheTest {

    @Override
    protected MailboxDataCache constructCache() throws ServiceException {
        MailboxDataCache cache = new LocalMailboxDataCache();
    ...
    protected void flushCacheBetweenTests() throws Exception {
        ((LocalMailboxDataCache)cache).flush();
    }
}
