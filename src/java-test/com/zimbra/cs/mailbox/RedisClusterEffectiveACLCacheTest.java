...
import com.zimbra.cs.mailbox.acl.RedisClusterEffectiveACLCache;
import com.zimbra.cs.store.MockStoreManager;
import com.zimbra.cs.util.Zimbra;
import com.zimbra.cs.util.ZimbraConfig;

/**
 * Unit test for {@link RedisClusterEffectiveACLCache}.
 */
public final class RedisClusterEffectiveACLCacheTest extends RedisEffectiveACLCacheTest {
    ...
    protected EffectiveACLCache constructCache() throws ServiceException {
        EffectiveACLCache cache = new RedisClusterEffectiveACLCache(Zimbra.getAppContext().getBean(JedisCluster.class));
