...
/**
 * Unit test for {@link LocalCalendarDataCache}.
 */
public final class LocalCalendarDataCacheTest extends AbstractCalendarDataCacheTest {

    @Override
    protected CalendarDataCache constructCache() throws ServiceException {
        CalendarDataCache cache = new LocalCalendarDataCache(10);
    ...
    protected void flushCacheBetweenTests() throws Exception {
        ((LocalCalendarDataCache)cache).flush();
    }
}
