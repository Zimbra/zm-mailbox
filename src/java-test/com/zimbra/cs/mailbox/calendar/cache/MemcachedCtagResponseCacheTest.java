...
/**
 * Unit test for {@link MemcachedCtagResponseCache}.
 */
public final class MemcachedCtagResponseCacheTest extends AbstractCtagResponseCacheTest {
    ...
    protected CtagResponseCache constructCache() throws ServiceException {
        CtagResponseCache cache = new MemcachedCtagResponseCache();
