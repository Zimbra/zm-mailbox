...
/**
 * Unit test for {@link MemcachedCalendarDataCache}.
 */
public final class MemcachedCalendarDataCacheTest extends AbstractCalendarDataCacheTest {
    ...
    protected CalendarDataCache constructCache() throws ServiceException {
        CalendarDataCache cache = new MemcachedCalendarDataCache();
