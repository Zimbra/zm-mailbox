...
/**
 * Unit test for {@link RedisCtagResponseCache}.
 */
public final class RedisCtagResponseCacheTest extends AbstractCtagResponseCacheTest {
    ...
    protected CtagResponseCache constructCache() throws ServiceException {
        CtagResponseCache cache = new RedisCtagResponseCache();
