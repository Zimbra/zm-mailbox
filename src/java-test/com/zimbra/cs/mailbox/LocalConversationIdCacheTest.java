...
/**
 * Unit test for {@link LocalConversationIdCache}.
 */
public final class LocalConversationIdCacheTest extends AbstractConversationIdCacheTest {

    @Override
    protected ConversationIdCache constructCache() throws ServiceException {
        ConversationIdCache cache = new LocalConversationIdCache();
    ...
    protected void flushCacheBetweenTests() throws Exception {
        ((LocalConversationIdCache)cache).flush();
    }
}
