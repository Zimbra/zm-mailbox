...
public class MimeHeaderTest {
    ...
    public void addressHeader() {
        ...
        MimeHeader.MimeAddressHeader hdr = new MimeHeader.MimeAddressHeader(
                "To", src);
    ...
    public void encode() {
        ...
        Assert.assertEquals("=?utf-8?Q?Re=3A_Pru=C3=AE?= Loo",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("Re: =?utf-8?B?UHJ1w64=?= Loo",
                MimeHeader.escape(src, null, false));

        src = "Re: Pru\u00ee Loo ";
        Assert.assertEquals("=?utf-8?Q?Re=3A_Pru=C3=AE_Loo_?=",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("Re: =?utf-8?Q?Pru=C3=AE_Loo_?=",
                MimeHeader.escape(src, null, false));

        src = "Fwd:   Pru\u00ee Loo";
        Assert.assertEquals("=?utf-8?Q?Fwd=3A___Pru=C3=AE?= Loo",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("Fwd:   =?utf-8?B?UHJ1w64=?= Loo",
                MimeHeader.escape(src, null, false));

        src = "Prue Loo  ";
        Assert.assertEquals("\"Prue Loo  \"",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("Prue Loo  ",
                MimeHeader.escape(src, null, false));

        src = "Fwd:  Pru\u00ee Loo ";
        Assert.assertEquals("=?utf-8?Q?Fwd=3A__Pru=C3=AE_Loo_?=",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("Fwd:  =?utf-8?Q?Pru=C3=AE_Loo_?=",
                MimeHeader.escape(src, null, false));
        ...
        src = "Pru\u00ee";
        Assert.assertEquals("=?utf-8?B?UHJ1w64=?=",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("=?utf-8?B?UHJ1w64=?=",
                MimeHeader.escape(src, null, false));

        src = "Pru\u00ee";
        Assert.assertEquals("=?iso-8859-1?Q?Pru=EE?=",
                MimeHeader.escape(src, "iso-8859-1", true));
        Assert.assertEquals("=?iso-8859-1?Q?Pru=EE?=",
                MimeHeader.escape(src, "iso-8859-1", false));

        src = "Pru\u00ee";
        Assert.assertEquals("=?utf-8?B?UHJ1w64=?=",
                MimeHeader.escape(src, "iso-8859-7", true));
        Assert.assertEquals("=?utf-8?B?UHJ1w64=?=",
                MimeHeader.escape(src, "iso-8859-7", false));
        ...
        src = "\u00eb\u00ec\u00ed\u00ee";
        Assert.assertEquals("=?utf-8?B?w6vDrMOtw64=?=",
                MimeHeader.escape(src, null, true));
        Assert.assertEquals("=?utf-8?B?w6vDrMOtw64=?=",
                MimeHeader.escape(src, null, false));

        src = "\u00eb\u00ec\u00ed\u00ee";
        Assert.assertEquals("=?iso-8859-1?B?6+zt7g==?=",
                MimeHeader.escape(src, "iso-8859-1", true));
        Assert.assertEquals("=?iso-8859-1?B?6+zt7g==?=",
                MimeHeader.escape(src, "iso-8859-1", false));
