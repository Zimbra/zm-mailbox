...
FROM ${DOCKER_REPO_NS}/zms-zcs-lib:1.1.0 as lib
...
FROM ${DOCKER_REPO_NS}/zms-core-network-extension:1.2.1 as ext-core-network
...
FROM ${DOCKER_REPO_NS}/zms-base:1.0.21
