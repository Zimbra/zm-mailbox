...
FROM ${DOCKER_REPO_NS}/zms-zcs-lib:1.0.9 as lib
...
FROM ${DOCKER_REPO_NS}/zms-admin-console:2.0.6 as admin-console
FROM ${DOCKER_REPO_NS}/zms-ldap-utilities:1.2 as ldap
FROM ${DOCKER_REPO_NS}/zms-timezones:2.0.1 as timezone
FROM ${DOCKER_REPO_NS}/zms-core-network-extension:1.2.0 as ext-core-network
...
FROM ${DOCKER_REPO_NS}/zms-base:1.0.20
